...
namespace HACS.Migrations
{
    ...
    [Migration("20241215182406_donations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HACS.Models.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HACS.Models.Users.DonationAdmin", b =>
                {
                    b.HasBaseType("HACS.Models.Users.User");

                    b.HasDiscriminator().HasValue("DonationAdmin");
                });

            modelBuilder.Entity("HACS.Models.Users.Donor", b =>
                {
                    b.HasBaseType("HACS.Models.Users.User");
            ...
            modelBuilder.Entity("HACS.Models.Donation", b =>
                {
                    b.HasOne("HACS.Models.Users.DonationAdmin", null)
                        .WithMany("ReviewedDonations")
                        .HasForeignKey("DonationAdminId");

                    b.HasOne("HACS.Models.Users.Donor", null)
